...
func TestCreateBankAccount(t *testing.T) {
	t.Run("ShouldReturnBankAccountResponseAndErrorNil_whenInsertSuccess", func(t *testing.T) {
	...
	t.Run("ShouldReturnBankAccountResponseAndError_whenInsertExecutionFailed", func(t *testing.T) {
		var mock, db = beforeEach(t)
		mockBankName := "MockBank"
		mockAccountName := "MockAccount"
		mockAccountNumber := "1234567890"
	...
	t.Run("ShouldReturnBankAccountResponseAndError_whenGetLastInsertedValueFailed", func(t *testing.T) {
		var mock, db = beforeEach(t)
		mockBankName := "MockBank"
		mockAccountName := "MockAccount"
		mockAccountNumber := "1234567890"
